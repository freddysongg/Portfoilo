...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative flex items-center justify-center space-x-4 rounded-full bg-white px-8 py-3 shadow-input dark:border-white/[0.2] dark:bg-gray-800/10 backdrop-blur-lg"
    >
      {children}
    </nav>
  );
